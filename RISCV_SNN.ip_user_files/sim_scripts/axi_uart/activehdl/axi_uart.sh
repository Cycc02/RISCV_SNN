...
#                script (type 'axi_uart.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Administrator/Documents/FYP_Docs/RISCV_SNN/RISCV_SNN.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
