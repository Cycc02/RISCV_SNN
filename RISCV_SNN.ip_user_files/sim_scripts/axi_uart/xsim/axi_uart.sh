...
#
# Script generated by Vivado on Mon Jun 08 10:23:08 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_uart.sh
...
#
# Usage        : axi_uart.sh
#                axi_uart.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_uart.sh [-rerun]
#                axi_uart.sh [-reset_run]
#                axi_uart.sh [-clean]
#                axi_uart.sh [-reset_log]
#                axi_uart.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L xilinx_vip"
...
# script info
echo -e "axi_uart.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_uart.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L axi_uartlite_v2_0_39 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_uart xil_defaultlib.axi_uart xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_uart -key {Behavioral:sim_1:Functional:axi_uart} -tclbatch cmd.tcl -protoinst "protoinst_files/ps_stub.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_uart.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_uart.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_uart.sh [-help]\n\
Usage: axi_uart.sh [-step]\n\
Usage: axi_uart.sh [-lib_map_path]\n\
Usage: axi_uart.sh [-rerun]\n\
Usage: axi_uart.sh [-reset_run]\n\
Usage: axi_uart.sh [-clean]\n\
Usage: axi_uart.sh [-reset_log]\n\
Usage: axi_uart.sh [-keep_index]\n\
Usage: axi_uart.sh [-noclean_files]\n\n\
