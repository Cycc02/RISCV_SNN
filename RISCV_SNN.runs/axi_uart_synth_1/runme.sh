...
HD_PWD='C:/Users/Administrator/Documents/FYP_Docs/RISCV_SNN/RISCV_SNN.runs/axi_uart_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_uart.tcl
